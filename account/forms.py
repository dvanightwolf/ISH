...
class UserRegistrationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        model = User
        # The form's fields
        fields = ("username", "email", "password", "confirm_password", "bio", "photo",  "gender",
                  "date_of_birth", "location", "phone_number")
...
class ProfileEditForm(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = ("username", "photo", "email", "bio", "gender", "date_of_birth", "location", "phone_number")
        help_texts = {"username": None}
